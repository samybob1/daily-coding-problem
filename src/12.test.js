...
const solve = require("./12");

test("a staircase with 4 steps, climbing 1 or 2 steps at a time, to be climbed with 5 unique ways", () => {
  const result = solve(4);
  expect(result).toBe(5);
});

test("a staircase with 4 steps, climbing 1, 3 or 5 steps at a time, to be climbed with 3 unique ways", () => {
